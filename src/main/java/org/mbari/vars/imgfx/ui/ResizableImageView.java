...
public class ResizableImageView extends Pane {
    ...
    private static final Logger log = System.getLogger(ResizableImageView.class.getName());
    ...
    private void imageChanged() {
        log.log(Level.TRACE, "imageChanged()");
