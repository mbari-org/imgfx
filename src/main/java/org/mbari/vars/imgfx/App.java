package org.mbari.vars.imgfx;

import org.mbari.vars.imgfx.ui.GlassBox;
import org.mbari.vars.imgfx.ui.ResizeableImagePaneController;
...
public class App extends Application {
    ...
    public void start(Stage stage) {
        ...
        ResizeableImagePaneController rip = new ResizeableImagePaneController(imageView);
        ...
        root.setOnMouseMoved(event -> {
            ...
            var msg = String.format("S: %.1f, %.1f | I: %.1f, %.1f", scenePoint.getX(),
                    scenePoint.getY(), imagePoint.getX(), imagePoint.getY());
            text.setText(msg);

        });
        rip.getGlass().getChildren().add(text);

        var box = new GlassBox(20, 20, 20, 20);
        rip.glassItems().add(box);
