...
import org.mbari.imgfx.util.StringUtils;
...
public class FilteredComboBoxDecorator<T>  {
    ...
    private static final System.Logger log = System.getLogger(FilteredComboBoxDecorator.class.getName());
    ...
    private void handleOnKeyPressed(KeyEvent keyEvent) {
        ...
        if (!keyEvent.isMetaDown()) {
            ...
            if (log.isLoggable(System.Logger.Level.DEBUG)) {
                log.log(System.Logger.Level.DEBUG, "Handling KeyCode = " + code);
            }
